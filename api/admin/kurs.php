...
if (Foresporsel::metode() === 'GET') {
    ...
    Svar::json(['kurs' => array_map(static function ($k) use (
        ...
        return [
            ...
            'utenForskudd'    => (bool) ($k['uten_forskudd'] ?? 0),
...
switch ($handling) {
    ...
    case 'lagre':
        ...
        $tekstfelter = [
            ...
            // «Kan bookes uten forskuddsbetaling» (migrasjon 197). Paa for
            // alle kurs fra start; her slaas den av paa dem som skal betales
            // i forkant.
            'utenForskudd'    => 'uten_forskudd',
        ];
        foreach ($tekstfelter as $inn => $kolonne) {
            ...
            if ($kolonne === 'gjenstand_i_kassa' || $kolonne === 'uten_forskudd') {
