...
$planer = static fn(): array => array_map(static fn($p) => [
    ...
    // Kan medlemskapet tegnes uten aa betale i forkant? Én bryter for alle
    // planer — ⊙ Synlighet → Betal ved oppmøte → Medlemskap (migrasjon 198),
    // av til noen slaar den paa. Fast trekk gaar foran: der er fullmakten
    // hele poenget, og da finnes ikke valget.
    'utenForskudd' => !Medlemskap::kreverFastTrekk($p) && Oppmote::medlemskap(),
