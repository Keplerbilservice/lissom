...
if (Nett::bryterPaa('salgsuke') && !Nett::mobilSkjult('salgsuke')) {
    ...
    $h .= '<section data-theme="ink" style="background: var(--lissom-brown);">'
        ...
        . '</div>'
        . Deler::knapp($f('knapp', null, 'Se medlemmenes keramikk'), ['href' => ['butikk' => '/butikk', 'medlemsbutikk' => '/butikk', 'kurs' => '/kurs', 'events' => '/events', 'medlemskap' => '/medlemskap', 'gavekort' => '/gavekort'][$maal] ?? '/butikk', 'size' => 'lg', 'iconAfter' => 'arrow-right'])
        . '</div>'
