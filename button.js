...
`,Ft=c`
  @font-face {
    font-family: 'VeryVerySans';
    font-style: normal;
    font-weight: 300 400 500 600 700;
    font-display: swap;
    src: url('https://designsystem.vippsmobilepay.com/fonts/v1/VeryVerySans.woff2')
...
`,V=e=>e/16,It=c`
  ...
  button {
    ...
    --vm-btn-weight: 600;
    --vm-btn-font: var(--vm-font-sans);
    --vm-btn-column-gap: ${V(6)}rem;
    --vm-btn-row-gap: ${V(6)}rem;
...
`;function H(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a}function U(e){"@babel/helpers - typeof";return U=typeof Symbol==`function`&&typeof Symbol.iterator==`symbol`?function(e){return typeof e}:function(e){return e&&typeof Symbol==`function`&&e.constructor===Symbol&&e!==Symbol.prototype?`symbol`:typeof e},U(e)}function Lt(e,t){if(U(e)!=`object`||!e)return e;var n=e[Symbol.toPrimitive];if(n!==void 0){var r=n.call(e,t||`default`);if(U(r)!=`object`)return r;throw TypeError(`@@toPrimitive must return a primitive value.`)}return(t===`string`?String:Number)(e)}function Rt(e){var t=Lt(e,`string`);return U(t)==`symbol`?t:t+``}function W(e,t,n){return(t=Rt(t))in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}function zt(e,t){if(t.has(e))throw TypeError(`Cannot initialize the same private elements twice on an object`)}function G(e,t,n){zt(e,t),t.set(e,n)}function Bt(e,t,n){if(typeof e==`function`?e===t:e.has(t))return arguments.length<3?t:n;throw TypeError(`Private element is not present on this object`)}function K(e,t){return e.get(Bt(e,t))}function q(e,t,n){return e.set(Bt(e,t),n),n}var J,Y,X,Z,Vt,Q,Ht,Ut,Wt,Gt,Kt,qt,Jt,Yt,Xt,Zt=[`orange`,`purple`,`stroked`],Qt=`vipps-mobilepay-button`,$=(Y=new WeakMap,X=new WeakMap,Z=new WeakMap,Vt=new WeakMap,Q=new WeakMap,Ht=new WeakMap,Ut=new WeakMap,Wt=new WeakMap,Gt=new WeakMap,Kt=new WeakMap,qt=new WeakMap,Jt=new WeakMap,Yt=new WeakMap,Xt=new WeakMap,J=class extends M{get brandLogo(){return K(Y,this)}set brandLogo(e){q(Y,this,e)}get miniBrandLogo(){return K(X,this)}set miniBrandLogo(e){q(X,this,e)}get textMessage(){return K(Z,this)}set textMessage(e){q(Z,this,e)}get buttonAriaLabel(){return K(Vt,this)}set buttonAriaLabel(e){q(Vt,this,e)}get language(){return K(Q,this)}set language(e){q(Q,this,e)}get branded(){return K(Ht,this)}set branded(e){q(Ht,this,e)}get compact(){return K(Ut,this)}set compact(e){q(Ut,this,e)}get type(){return K(Wt,this)}set type(e){q(Wt,this,e)}get disabled(){return K(Gt,this)}set disabled(e){q(Gt,this,e)}get brand(){return K(Kt,this)}set brand(e){q(Kt,this,e)}get verb(){return K(qt,this)}set verb(e){q(qt,this,e)}get vmpContinueAsFirstName(){return K(Jt,this)}set vmpContinueAsFirstName(e){q(Jt,this,e)}get variant(){return K(Yt,this)}set variant(e){q(Yt,this,e)}get loading(){return K(Xt,this)}set loading(e){q(Xt,this,e)}constructor(){if(super(),W(this,`internals`,void 0),W(this,`isSupportElementInternals`,!1),G(this,Y,kt),G(this,X,jt),G(this,Z,``),G(this,Vt,null),G(this,Q,ht),G(this,Ht,!0),G(this,Ut,!1),G(this,Wt,`button`),G(this,Gt,!1),G(this,Kt,`vipps`),G(this,qt,`buy`),G(this,Jt,``),G(this,Yt,`primary`),G(this,Xt,!1),this.attachInternals&&(this.internals=this.attachInternals(),this.isSupportElementInternals=!0),!document.head.querySelector(`style[data-vipps-mobilepay-button-fonts]`)){let e=document.createElement(`style`);e.setAttribute(`data-vipps-mobilepay-button-fonts`,``),e.innerHTML=Ft.cssText,document.head.appendChild(e)}this.rejectVippsForFinland(),this.updateLogo(),this.textMessage=this.getTextContent(),this.buttonAriaLabel=this.getButtonAriaLabel()}rejectVippsForFinland(){this.language.toLowerCase()===`fi`&&this.brand.toLowerCase()===`vipps`&&(console.info(`[Vipps MobilePay Button]
Language ${this.language} is not supported when using brand Vipps.`),this.language=`en`)}updateLogo(){let e=this.brand.toLowerCase()===`mobilepay`;this.brandLogo=e?At:kt,this.miniBrandLogo=e?Mt:jt}getTextContent(){switch(this.verb.toLowerCase()){case`pay`:return this.compact?I(T`${this.miniBrandLogo} <span>Betal</span>`):this.branded?I(T`<span>Betal med </span>${this.brandLogo(I)}`):I(`Betal`);case`login`:return this.compact?I(T`${this.miniBrandLogo} <span>Logg inn</span>`):this.branded?I(T`<span>Logg inn med </span>${this.brandLogo(I)}`):I(`Logg inn`);case`register`:return this.compact?I(T`${this.miniBrandLogo} <span>Registrer</span>`):this.branded?I(T`<span>Registrer med </span>${this.brandLogo(I)}`):I(`Registrer`);case`continue`:return this.vmpContinueAsFirstName?this.compact||this.branded?I(T`${this.miniBrandLogo} <span>Fortsett som ${this.vmpContinueAsFirstName}</span>`):I(T`Fortsett som ${this.vmpContinueAsFirstName}`):this.compact?I(T`${this.miniBrandLogo} <span>Fortsett</span>`):this.branded?I(T`<span>Fortsett med </span>${this.brandLogo(I)}`):I(T`Fortsett`);case`confirm`:return this.compact?I(T`${this.miniBrandLogo} <span>Bekreft</span>`):this.branded?I(T`<span>Bekreft med </span>${this.brandLogo(I)}`):I(T`Bekreft`);case`donate`:return this.compact?I(T`${this.miniBrandLogo} <span>Bidra</span>`):this.branded?I(T`<span>Bidra med </span>${this.brandLogo(I)}`):I(T`Bidra`);case`add-card`:return this.compact?I(T`${this.miniBrandLogo} <span>Legg til kort</span>`):this.branded?I(T`<span>Legg til kort med </span>${this.brandLogo(I)}`):I(T`Legg til kort`);case`express`:return this.compact?I(T`${this.miniBrandLogo} <span>Express</span>`):this.branded?T`${this.brand.toLowerCase()===`mobilepay`?T`<span class="mobilepay-logo">MobilePay</span>`:this.brandLogo(I)}<span> Express</span>`:I(`Express`);default:return this.compact?I(T`${this.miniBrandLogo} <span>Kjøp nå</span>`):this.branded?I(T`<span>Kjøp nå med </span>${this.brandLogo(I)}`):I(`Kjøp nå`)}}getButtonAriaLabel(){if(this.verb.toLowerCase()!==`express`)return null;let e=this.brand.toLowerCase()===`mobilepay`?`MobilePay`:`Vipps`;return I(F`Kjøp nå med ${e} Express`)}getForm(){var e;return this.isSupportElementInternals?(e=this.internals)==null?void 0:e.form:this.closest(`form`)}willUpdate(e){this.rejectVippsForFinland(),e.has(`brand`)&&this.updateLogo(),this.textMessage=this.getTextContent(),this.buttonAriaLabel=this.getButtonAriaLabel(),Zt.includes(this.variant)&&console.warn(`[Vipps MobilePay Button]
...
See https://developer.vippsmobilepay.com/docs/knowledge-base/design-guidelines/buttons/ for more information.`),e.has(`language`)&&Ot(this.language)&&Dt(this.language)}click(){let e=this.getForm();if(this.type!==`submit`||!e)return;if(e.requestSubmit){e.requestSubmit();return}let t=document.createElement(`input`);t.type=`submit`,t.style.display=`none`,e.appendChild(t),t.click(),e.removeChild(t)}connectedCallback(){super.connectedCallback();let e=this.getForm();this.type!==`submit`||!e||(this.addEventListener(`click`,()=>{this.click()}),e.addEventListener(`keypress`,e=>{e.code===`Enter`&&this.click()}))}render(){var e;return T` <button
    ...
    >
      ${this.loading?Nt:D} ${this.textMessage}
    </button>`}},W(J,`styles`,[It,Pt]),W(J,`formAssociated`,!0),J);H([P()],$.prototype,`brandLogo`,null),H([P()],$.prototype,`miniBrandLogo`,null),H([P()],$.prototype,`textMessage`,null),H([P()],$.prototype,`buttonAriaLabel`,null),H([N({type:String})],$.prototype,`language`,null),H([N({converter:e=>e===`true`||e===``})],$.prototype,`branded`,null),H([N({converter:e=>e===`true`||e===``})],$.prototype,`compact`,null),H([N({type:String})],$.prototype,`type`,null),H([N({converter:e=>e===`true`||e===``})],$.prototype,`disabled`,null),H([N({type:String})],$.prototype,`brand`,null),H([N({type:String})],$.prototype,`verb`,null),H([N({type:String})],$.prototype,`vmpContinueAsFirstName`,null),H([N({type:String})],$.prototype,`variant`,null),H([N({converter:e=>e===`true`||e===``})],$.prototype,`loading`,null),$=H([Xe()],$),customElements.get(Qt)||customElements.define(Qt,$)})();